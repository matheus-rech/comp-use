...
public class OpenLoop extends BlackBox{
    private Vector openPath = new Vector();     // open path boxes
    private Vector segments = new Vector();     // start of segment, end of segment, type of each segment, i.e. analogue, digital, AtoD, DtoA, ZOH
