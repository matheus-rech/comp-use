...
public class PropDeriv extends BlackBox{
    ...
    public PropDeriv(){
        super.sNumerDeg = 1;
        super.sDenomDeg = 0;
        super.sNumer = new ComplexPoly(1.0D, 0.0D);
        super.sDenom = new ComplexPoly(1.0D);
        super.sZeros = Complex.oneDarray(1);
        super.sZeros[0].reset(-1.0D/0.0D, 0.0D);
    ...
    public void setSnumer(double[] coeff){
        System.out.println("Transfer numerator is set by a constructor or special methods in PropDeriv; Not by setSnumer()");
    }
    ...
    public void setSdenom(double[] coeff){
        System.out.println("Transfer denominator is set by a constructor or special methods in PropDeriv; Not by setSdenom()");
    }
    ...
    public void setZnumer(double[] coeff){
        System.out.println("Transfer numerator is set by special methods in PropDeriv; Not by setZnumer()");
    }
    ...
    public void setZdenom(double[] coeff){
        System.out.println("Transfer numerator is set by special methods in PropDeriv; Not by setZdenom()");
    }
