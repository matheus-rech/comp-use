...
public class PropIntDeriv extends BlackBox{
    ...
    public PropIntDeriv(){
        super.sNumerDeg = 2;
        super.sDenomDeg = 1;
        super.sNumer = new ComplexPoly(0.0D, 1.0D, 0.0D);
        super.sDenom = new ComplexPoly(0.0D, 1.0D);
        super.sZeros = Complex.oneDarray(2);
        ...
        super.zPoles = Complex.oneDarray(2);
    ...
    public void setSnumer(double[] coeff){
        System.out.println("Transfer numerator is set by a constructor or special methods in PropIntDeriv; Not by setSnumer()");
    }
    ...
    public void setSdenom(double[] coeff){
        System.out.println("Transfer denominator is set by a constructor or special methods in PropIntDeriv; Not by setSdenom()");
    }
    ...
    public void setZnumer(double[] coeff){
        System.out.println("Transfer numerator is set by special methods in PropIntDeriv; Not by setZnumer()");
    }
    ...
    public void setZdenom(double[] coeff){
        System.out.println("Transfer numerator is set by special methods in PropIntDeriv; Not by setZdenom()");
    }
