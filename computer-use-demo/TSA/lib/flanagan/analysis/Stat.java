...
*   Stat.html
*
*   Copyright (c) April 2004, 18 June 2005
*
*   PERMISSION TO COPY:
...
public class Stat{
       ...
       // Returns an array of maximal Gumbel (Type I EVD) random deviates - user supplied seed
        ...
        public static Vector upperOutliersAnscombe(double[] values, double constant){
            boolean test=true;
            double[] copy0 = (double[])values.clone();
            int nValues = values.length;
            int nValues0 = nValues;
            Vector outers = new Vector();
            int nOutliers = 0;
        ...
        public static Vector lowerOutliersAnscombe(double[] values, double constant){
            boolean test=true;
            double[] copy0 = (double[])values.clone();
            int nValues = values.length;
            int nValues0 = nValues;
